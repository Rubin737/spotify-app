...
const HomePage = () => {
    ...
    return (_jsxs("div", { className: "space-y-3", children: [_jsx("div", { className: "pt-2", children: _jsx(TopBar, {}) }), _jsx(FeaturedSongs, { title: "Good Morning", songs: featuredSongs, isLoading: isLoading, error: error }), _jsx(SongsGrid, { title: "Made For You", songs: madeForUSongs, isLoading: isLoading, error: error }), _jsx(SongsGrid, { title: "Trending Songs", songs: trendingSongs, isLoading: isLoading, error: error })] }));
};
